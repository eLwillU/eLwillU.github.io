import { m as createComponent, h, n as hSlot, y as hUniqueSlot, a9 as QIcon, g as getCurrentInstance, M as useDarkProps, O as useDark, c as computed, t as noop, r as ref, w as watch, u as nextTick, aN as debounce, f as onBeforeMount, aO as onDeactivated, aP as onActivated, q as onBeforeUnmount, o as onMounted, Y as getScrollTarget, v as listenOpts, a1 as hMergeSlot, aQ as useFieldProps, aR as useFieldEmits, aS as useField, aT as useFieldState, aJ as useSizeProps, aK as useSize, U as hDir, aU as hMergeSlotSafely, aV as Ripple, K as stopAndPrevent, aW as useFormProps, aX as useFormInputNameAttr, aY as fieldValueIsFilled, aZ as isDeepEqual, a_ as onBeforeUpdate, a$ as onUpdated, G as prevent, b0 as useKeyComposition, H as stop, af as isKeyCode, b1 as shouldIgnoreKey, aI as QDialog, b2 as vmHasRouter, b3 as History, b4 as isNumber, b5 as isDate, b6 as isObject, b7 as injectMultipleProps, b8 as QCheckbox, b9 as injectProp, a6 as QBtn, aa as QSeparator, a3 as openBlock, a4 as createBlock, a5 as withCtx, k as createVNode, a7 as createTextVNode } from "./index.2bb0558a.js";
import { a as QList, n as normalizeToInterval, Q as QMenu, e as QItemSection, d as QItem } from "./format.bdf96be8.js";
import { Q as QLinearProgress } from "./QLinearProgress.e7b6184e.js";
import { Q as QPage } from "./QPage.7aad478e.js";
...
const _sfc_main = {
  __name: "overviewQuestionnairePage",
  setup(__props) {
    const data = ref("");
    ...
    async function fetchData() {
      try {
        ...
        questionnaire.value = new dist.QuestionnaireData(data.value, ["de"]);
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(QPage, { class: "q-pa-md" }, {
        default: withCtx(() => [
          createVNode(QBtn, { onClick: logData }, {
            default: withCtx(() => [
          ...
          createVNode(QTable, {
            ...
            "body-cell-action": withCtx((props) => [
              createVNode(QBtn, {
                ...
                onClick: ($event) => handleActionClick(props.row.action)
